...
2. Iniciar sesión con **`atena.unikonrad@gmail.com`** / `AtenaPro2026#`
...
| **Firebase** (base de datos) | [console.firebase.google.com](https://console.firebase.google.com) | `atena.unikonrad@gmail.com` / `AtenaPro2026#` |
| **Google AI Studio** (API Key) | [aistudio.google.com](https://aistudio.google.com) | `atena.unikonrad@gmail.com` / `AtenaPro2026#` |
...
| **Contraseña Institucional** | `AtenaPro2026#` |
